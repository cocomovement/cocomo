...
class RestaurantProfilesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create restaurant_profile" do
    assert_difference('RestaurantProfile.count') do
      post restaurant_profiles_url, params: { restaurant_profile: { address: @restaurant_profile.address, description: @restaurant_profile.description, email: @restaurant_profile.email, food_type: @restaurant_profile.food_type, green_status: @restaurant_profile.green_status, name: @restaurant_profile.name, phone: @restaurant_profile.phone } }
    end
  ...
  test "should update restaurant_profile" do
    patch restaurant_profile_url(@restaurant_profile), params: { restaurant_profile: { address: @restaurant_profile.address, description: @restaurant_profile.description, email: @restaurant_profile.email, food_type: @restaurant_profile.food_type, green_status: @restaurant_profile.green_status, name: @restaurant_profile.name, phone: @restaurant_profile.phone } }
